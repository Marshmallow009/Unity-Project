...
public class LASER : MonoBehaviour, IMagicSpell
{
    ...
    void Start()
    {
        ...
        foreach (var other in GameObject.FindGameObjectsWithTag("Wand"))
        {
            if (other != gameObject)
            {
                Collider otherCollider = other.GetComponent<Collider>();
        ...
        foreach (var other in GameObject.FindGameObjectsWithTag("MainCamera"))
        {
            if (other != gameObject)
            {
                Collider otherCollider = other.GetComponent<Collider>();
